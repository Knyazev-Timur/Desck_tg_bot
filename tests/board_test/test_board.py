...
class TestBoardView:
    ...
    #
    #     expected_response: Dict = BoardParticipantSerializer(active_boards, many=True).data
    ...
    #         BoardParticipantFactory(board=board, user=user)
    #
    #     unexpected_response: Dict = BoardParticipantSerializer(
    ...
    #
    #     unexpected_response: Dict = BoardParticipantSerializer(boards, many=True).data
    #     response: Response = auth_client.get(self.url)
    #
    #     assert response.status_code == status.HTTP_200_OK, "Запрос не прошел"
